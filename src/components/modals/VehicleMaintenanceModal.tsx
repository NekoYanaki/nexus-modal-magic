        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="maintenance" className="p-6 mt-0">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              {/* Left Side - Maintenance Schedule (3/5) */}
              ...
              {/* Right Side - Active Job Panel (2/5) */}
              <div className="lg:col-span-2">
                <Card className={`p-5 ${hasActiveJob ? "border-success" : "border-dashed"}`}>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <Wrench className="w-5 h-5 text-warning" />
                      <h4 className="font-semibold">Maintenance Job Panel</h4>
                    </div>
                    {hasActiveJob && (
